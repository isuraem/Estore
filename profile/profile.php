...
<div class="f-image"> 
    ...
    <a href="#"><button><center>view</center></button></a>
</div>
...
<div class="edit">
    ...
    <input class="editname" type="text"  value=<?php echo $_SESSION['username']?>>
  
    <p> <i class="fa fa-envelope"></i>  Email</p>
	
    <input class="editemail" type="text" placeholder="" value=<?php echo $_SESSION['email']?>>
...
<form method="post" action ="comments.php">
    ...
    <p>Comment Area</p>
    <p>Name</p>
	 <input class="editphone" type="text" placeholder="" name="ucomment" required>
	 <p>your comment </p>
    <input class="editphone" type="text" placeholder="" name="comments" required>
	<br>
