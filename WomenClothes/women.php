...
<hr>
   <main>
        ...
        <div class="trendzbox">
                <div class="clip">
                    <h1>Women <br> Clothing</h1>
            </div>
            <div class="s">
                <div class="s1">
                    <div class="simage1">
                        <img src="dresses/1.jpg"alt="image1">
                    </div>
                <div class="size">
                    <div class="small">
                        <a href="#">S</a>
                ...
                <div class="view1">
                    <a href="item1.html"><button class="button view" >View Item</button></a>
                </div>
                ...
                <div class="s1">
                    <div class="simage1">
                        <div class="image2"><img src="dresses/a.jpg"alt="image1"></div>
                    </div>
                <div class="size">
                    <div class="small">
                        <a href="#">S</a>
                ...
                <div class="view1">
                    <a href="item2.html"><button  class="button view">View Item</button></a>
                </div>
                ...
                <div class="s1">
                    <div class="simage1">
                        <div class="image3">
                            <img src="dresses/b.jpg"alt="image1">
                        </div>
                ...
                <div class="view1">
                    <a href="item3.html"><button class="button view">View Item</button></a>
                </div>
