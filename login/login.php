...
<hr>
   <main>
<div class="clip">
    <h1 style="color: white; opacity: 0.7; font-family: 'Quicksand', sans-serif;font-size: 24px;">Login</h1>
</div>
...
<input class="username" type="text" placeholder="Enter Username" name="name" required>
<input class="userpassword" type="text" placeholder="password" name="pwd" required>
</div>

<button type="submit" name="login">Login</button>
        <tr><br><td><input type="radio" id="candidate" name="login" value="candidate" checked><label style="color:white;">candidate</label></td></tr>
		<tr><td><input type="radio" id="employee" name="login" value="employee"><label  style="color:white;" >Employee</label></td></tr>
</form>
<p>OR<br>login with</p> 
<div class="llinks">
<a href="https://touch.facebook.com/?_rdr"><i class="material-icons" style="font-size:25px;">facebook</i></a>
